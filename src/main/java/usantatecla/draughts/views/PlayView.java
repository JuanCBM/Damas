...
class PlayView extends SubView {
    ...
    private String read(ColorPalette colorPalette) {
        final String titleColor = PlayView.PROMPT.replace(PlayView.COLOR_PARAM ,PlayView.COLOR_VALUES[colorPalette.ordinal()]);
