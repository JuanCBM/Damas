...
class PlayView extends SubView {
    ...
    private String read(PaletteColor paletteColor) {
        final String titleColor = PlayView.PROMPT.replace(PlayView.COLOR_PARAM ,PlayView.COLOR_VALUES[paletteColor.ordinal()]);
