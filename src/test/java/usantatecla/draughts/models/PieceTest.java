...
public class PieceTest {
  ...
  public void testGivenNullOriginPieceWhenIsAdvancedThenError() {
    new Pawn(Color.WHITE).isAdvanced(null, new Coordinate(4, 1));
  }

  @Test(expected = AssertionError.class)
  public void testGivenNullTargetPieceWhenIsAdvancedThenError() {
    new Pawn(Color.WHITE).isAdvanced(new Coordinate(4, 1), null);
  }
